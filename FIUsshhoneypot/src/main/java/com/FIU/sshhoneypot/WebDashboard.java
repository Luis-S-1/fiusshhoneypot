 ...
 */
=======
>>>>>>> 946834c (Removed plain text entry for the API keys. Instead they're now variables to be exported within the Terminal.)
...
private static String summarizeWithOpenAI(String logContent, String apiKey, String projectId) {
    ...
    JSONObject systemMsg = new JSONObject()
            .put("role", "system")
            .put("content", "Here's the log from our intruder interacting with an SSH honeypot, tell me what they were doing.");
